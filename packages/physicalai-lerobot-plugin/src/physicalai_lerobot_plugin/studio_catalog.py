...
def _ensure_lerobot_configs_imported() -> None:
    ...
    """
    global _LEROBOT_CONFIGS_IMPORTED
...
def _ensure_lerobot_third_party_plugins_imported() -> None:
    ...
    """
    global _LEROBOT_THIRD_PARTY_PLUGINS_IMPORTED
...
def _to_payload_annotation(annotation: object) -> object:
...
def _ensure_lerobot_teleoperators_imported() -> None:
    ...
    """
    global _LEROBOT_TELEOPERATORS_IMPORTED
